const tarotDataKo = [
  ...
  },
  {
    ...
    "meanings": {
      "upright": "운명의 수레바퀴, 전환점, 필연성, 행운",
      "reversed": "불운의 기운, 통제 불가한 변화",
      "love": "운명적인 인연, 예기치 않게 관계가 급진전됨",
      "career": "뜻밖의 행운, 예기치 않은 타이밍의 승진 및 이동",
      "advice": "운명의 큰 흐름이 시작되었습니다. 억지로 통제하려 무리하지 말고 흐름에 맡기세요."
    }
  },
  {
    "id": 11,
